# This represents a simplified version of the book catalog component.
class Book:
...
catalog = BookCatalog()
catalog.add_book("The Forty Rules of Love", "Elif Shafak", 8.99)
catalog.add_book("Twilight", "Stephenie Meyer", 12.99)
